...
file](https://github.com/aakash4dev/tendermint/blob/v0.34.x/proto/tendermint/abci/types.proto).
...
```bash
mkdir -p \
  $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/abci \
  $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/version \
  $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/types \
  $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/crypto \
  $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/libs \
  $KVSTORE_HOME/src/main/proto/github.com/gogo/protobuf/gogoproto

cp $GOPATH/src/github.com/aakash4dev/tendermint/proto/tendermint/abci/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/abci/types.proto
cp $GOPATH/src/github.com/aakash4dev/tendermint/proto/tendermint/version/version.proto \
   $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/version/version.proto
cp $GOPATH/src/github.com/aakash4dev/tendermint/proto/tendermint/types/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/types/types.proto
cp $GOPATH/src/github.com/aakash4dev/tendermint/proto/tendermint/types/evidence.proto \
   $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/types/evidence.proto
cp $GOPATH/src/github.com/aakash4dev/tendermint/proto/tendermint/types/params.proto \
   $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/types/params.proto
cp $GOPATH/src/github.com/aakash4dev/tendermint/proto/tendermint/crypto/merkle.proto \
   $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/crypto/merkle.proto
cp $GOPATH/src/github.com/aakash4dev/tendermint/proto/tendermint/crypto/keys.proto \
   $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/crypto/keys.proto
cp $GOPATH/src/github.com/aakash4dev/tendermint/proto/tendermint/libs/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/aakash4dev/tendermint/proto/tendermint/libs/types.proto
...
specification"](https://github.com/aakash4dev/tendermint/blob/v0.34.x/spec/abci/apps.md#gas).
...
package](https://godoc.org/github.com/aakash4dev/tendermint/light)) can leverage
...
[here](https://github.com/aakash4dev/tendermint/tree/v0.34.x/spec/abci/).
...
```bash
$ rm -rf /tmp/example
$ cd $GOPATH/src/github.com/aakash4dev/tendermint
$ make install
...
Github](https://github.com/aakash4dev/tendermint/issues/new/choose). To dig
