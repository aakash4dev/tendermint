...
(ABCI)](https://github.com/aakash4dev/tendermint/tree/v0.34.x/abci)
...
[Tendermint Core](https://github.com/aakash4dev/tendermint) (the
...
specification](https://github.com/aakash4dev/tendermint/blob/v0.34.x/spec/abci/abci.md).
