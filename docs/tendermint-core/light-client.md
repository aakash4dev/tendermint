...
See our [light
package](https://pkg.go.dev/github.com/aakash4dev/tendermint/light?tab=doc).
...
[Trust Options](https://pkg.go.dev/github.com/aakash4dev/tendermint/light?tab=doc#TrustOptions)
