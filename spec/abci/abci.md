...
information can be found in either [data structures](https://github.com/aakash4dev/tendermint/blob/v0.34.x/spec/core/data_structures.md)
or [accountability](https://github.com/aakash4dev/tendermint/blob/v0.34.x/spec/light-client/accountability/)
